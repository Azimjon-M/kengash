...
const renderActiveShape = (props) => {
  ...
  return (
    <g>
      ...
      <text className="font-bold text-xs" x={ex + (cos >= 0 ? 1 : -1) * 5} y={ey} textAnchor={textAnchor} fill="#355070">{`${name}`}</text>
    </g>
  );
};
    ...
    <div className="max-w-7xl mx-auto min-h-[calc(100vh-189px)]">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 mt-10 px-5">
        <div className="shadow-lg rounded-xl border p-4">
          ...
          <h2 className="p-2 shadow-md rounded-md text-sm md:text-lg text-gray-500 bg-slate-100"><span className="font-bold text-green-700">Taklif: </span>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Provident, dolore!</h2>
        </div>
        <div className="shadow-lg rounded-xl border p-4">
          <ResponsiveContainer width="100%" height={350}>
            <PieChart width={400} height={400}>
