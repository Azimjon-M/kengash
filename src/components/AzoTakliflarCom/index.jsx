                                    ...
                                    <div className="border-2 rounded p-2 lg:px-8 mb-5 shadow-md">
                                        ...
                                        <div className="flex items-center justify-between md:justify-end">
                                            <button
                                                ...
                                                className="btn btn-sm md:btn md:text-white rounded bg-green-600 hover:bg-green-500 md:bg-green-600 w-[100px] md:w-[120px] lg:text-lg md:mx-3 text-white"
                                            >
                                                Roziman
                                            </button>
                                            <button
                                                ...
                                                className="btn btn-sm md:btn md:text-white rounded bg-red-600 hover:bg-red-500 md:bg-red-600 w-[100px] md:w-[120px] lg:text-lg md:mx-3 text-white"
                                            >
                                                Qarshiman
                                            </button>
                                            <button
                                                ...
                                                className="btn btn-sm md:btn md:text-white rounded bg-yellow-600 hover:bg-yellow-500 md:bg-yellow-600 w-[100px] md:w-[120px] lg:text-lg md:ml-3 text-white"
                                            >
                                                Betarafman
                                            </button>
                                        </div>
