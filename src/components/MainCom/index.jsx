...
const MainCom = () => {
    return (
        <div className="w-full h-[calc(100vh-114px)] flex flex-col md:flex-row items-center md:justify-center md:items-start gap-y-4 md:gap-x-20 lg:gap-x-12 xl:gap-x-24 2xl:gap-x-36 py-12 lg:py-16 bg-[#F3F7FA] text-black">
